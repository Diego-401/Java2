...
public class Recursivo {
    ...
    public static void menuPotencia(Scanner sn){
        ...
        System.out.println(potenciaRecursiva(numeroBase,potencia));
    }

    public static float potenciaRecursiva(int numeroBase,int potencia){
        if(potencia==0){
            return 1;
        }else if(potencia==1){
            return numeroBase;
        }else if(potencia>1){
            return numeroBase*(potenciaRecursiva(numeroBase,potencia-1));
        }else{
            //return (1f/numeroBase)*(1f/potenciaRecursiva(numeroBase,potencia+1));
            return potenciaRecursiva(numeroBase,potencia+1)/numeroBase;
        }
    } 
    ...
    public static Float sumaRecursiva(int numeroBase){
        if(numeroBase<10){
            return numeroBase%10F;
        }
        return numeroBase%10 + sumaRecursiva(numeroBase/10);
    }
}
